            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">Silahkan kelola Menambah, mengubah dan menghapus halaman profile <span class="text-primary">makasihh 😎</span></h6>
                </div>
                <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <form class="forms-sample" action="<?= site_url('admin/profile/store'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="visi" required  class="form-control" id="exampleInputPassword1" placeholder="visi"></textarea>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">visi</label>
                      <textarea name="misi" required  class="form-control" id="exampleInputPassword1" placeholder="misi"></textarea>
                    </div>
                    <div class="form-group">
