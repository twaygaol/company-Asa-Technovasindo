        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
              ...
              <div class="card">
                <div class="card-body">
                  <form class="forms-sample" action="<?= site_url('admin/slider/store'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="description" required  class="form-control" id="exampleInputPassword1" placeholder="description"></textarea>
                    </div>
