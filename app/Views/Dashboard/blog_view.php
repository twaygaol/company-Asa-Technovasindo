            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">TAMBAH POSTINGAN</h3>
              ...
              <div class="card">
                <div class="card-body">
                <!-- <form action="<?= site_url('/admin/blog/store') ?>" method="post">
                  ...
                  <form class="forms-sample" action="<?= site_url('admin/blog/store'); ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Judul</label>
                      <input type="text" class="form-control" id="title" placeholder="Title Slider" name="title" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Konten</label>
                      <textarea name="content" required  class="form-control" id="content" placeholder="description content"></textarea>
                    </div>
                    <div class="form-group">
...
<body>
    ...
    <a href="<?= site_url('blog/delete/' . $post['id']) ?>">Hapus</a>
</body>
</html> -->
